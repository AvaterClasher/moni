...
import { HiPhone, HiArrowSmRight } from 'react-icons/hi';
import {HiChip, HiSupport} from 'react-icons/hi'
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <HiPhone className='w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <HiSupport className='w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
