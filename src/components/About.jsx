    ...
    <div classname="w-full my-60">
        <div className='max-w-[1240px] mx-auto'>
            <div className='text-center'>
                ...
                <p className='text-3xl py-6 text-gray-500'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, dolorum dignissimos asperiores pariatur facilis, quibusdam eaque sunt ipsum nesciunt magni ipsa? Rerum expedita dolorem minus deserunt explicabo tenetur, voluptate minima.</p>
            </div>
